...
import DhruvAcedemy.Resources.ExtentReportNG;
import DhruvAcedemy.SeleniumFrameworkDesign.MainTest;
...
public class Listeners extends MainTest implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		// test.log(Status.FAIL, testName+" is Failed..Taken Screenshot");
